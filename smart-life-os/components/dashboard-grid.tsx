...
const widgetRenderers: Partial<Record<WidgetId, ReactElement>> = {
          ...
          {orderedWidgets.map((widget) => (
            <button
              ...
              className={`rounded-md border px-3 py-2 text-xs font-semibold transition ${
                widget.enabled ? "border-cyan-300 bg-cyan-300/10 text-cyan-100" : "border-slate-700 bg-slate-950/40 text-slate-400"
              }`}
            >
